...
namespace how_trouble
{
    public partial class Form1 : Form
    {
        ...
        private void Open_MenuItem1_Click(object sender, EventArgs e)
        {
            if (this.axMapControl1.LayerCount > 0)
            {
        ...
        private void Save_As_MenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void axToolbarControl1_OnMouseMove(object sender, AxESRI.ArcGIS.Controls.IToolbarControlEvents_OnMouseMoveEvent e)
        {
            //取得鼠标所在工具的索引号
        ...
        private void axMapControl1_OnMapReplaced(object sender, AxESRI.ArcGIS.Controls.IMapControlEvents2_OnMapReplacedEvent e)
        {
        ...
        private void axMapControl1_OnExtentUpdated(object sender, AxESRI.ArcGIS.Controls.IMapControlEvents2_OnExtentUpdatedEvent e)
        {//绘制鹰眼的矩形框
            //得到新范围
